...
import {
    IllustrationMusic,
    IllustrationInfluencer,
    IllustrationPersonalFile,
    IllustrationImagePost,
} from "../illustrations";
...
export const DropBox = (props) => {
    ...
    function uploadBoxDropOverOrEnter(evt) {
        ...
        document
            ...
            .classList.add("dropAreaFileHover");
    }
    ...
    function uploadBoxOnDrop(evt) {
        ...
        removeDropZone();
        if (props.type === "videoToMp3" || props.type === "videoCrop")
            return props.loadVideo();
        ...
        <>
            ...
            >
                <div id="dropContainer" className="dropZone">
                    <div
                        className={`svgContainer ${props?.mp3url ? "additionalPadding" : ""}`}
                    >
                        {props.type === "videoToMp3" && (
                            <IllustrationMusic
                        ...
                        {props.type === "videoCrop" && (
                            <IllustrationInfluencer
                                progressBar={props.progressBar}
                                progressBarTotal={props.progressBarTotal}
                            />
                        )}
                        {props.type === "pdfToPng" && (
                            <IllustrationPersonalFile />
                    ...
                    <label
                        htmlFor="fileInput"
                        id="uploadText"
                        onClick={(e) => handleMp3ChangeFile(e)}
                        onKeyDown={(e) => handleMp3ChangeFile(e)}
                    >
                        {!isMobile ? (
                            <>
            ...
            <div
                ...
                role="button"
                onKeyDown={(e) => {
                    if (e.code === "Enter") return clickLabel();
                }}
                onDragOver={uploadBoxDropOverOrEnter}
                onDragEnter={uploadBoxDropOverOrEnter}
