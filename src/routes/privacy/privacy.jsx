            ...
            <div className="privacy">
                <div>
                    ...
                    <p>
                        ...
                        information that is collected and recorded by lesi.dev
                        and how it is used.
                    </p>
                    ...
                    <p>
                        ...
                        (GDPR) of the European Union. This Privacy Policy
                    ...
                    <p>
                        ...
                        <ul>
                            <li>
                                ...
                                device that help us recognize you and remember
                                your preferences.
                            </li>
                        </ul>
                    </p>
                    ...
                    <h2>3. Use of Data</h2>
                    <p>
                        The data we collect may be used for the following
                        purposes:
                        <ul>
                    ...
                    <p>
                        ...
                        on your prior visits to lesi.dev or other websites.
                        Google&apos;s use of advertising cookies enables it and
                        its partners to serve ads to you based on your visit to
                        lesi.dev and/or other sites on the Internet.
                    </p>
                    <p>
                        <strong>Cookies and Data Use:</strong> Google AdSense
                        may collect personal data such as IP addresses and may
                        use cookies and similar technologies to provide you with
                        relevant advertisements. For more information on how
                        Google uses data when you use our site, please visit{" "}
                    ...
                    <p>
                        ...
                        the risk of processing your personal data. However,
                    ...
                    <p>
                        ...
                        changes. Any updates will be posted on this page with an
